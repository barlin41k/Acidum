...
namespace Acidum {
VulkanPipeline::VulkanPipeline(const VulkanDevice& device, VkFormat swapChainFormat, VkFormat depthFormat, const PipelineConfig& config)
    : m_device(device) {
...
void VulkanPipeline::createGraphicsPipeline(const PipelineConfig& config) {
    ...
    depthStencil.depthTestEnable = static_cast<VkBool32>(config.enableDepthTest);
